...
module HPCPack
  class Helpers
    ...
    def self.keyvault_get_secret(vault_name, secret_key, managed_id)
      ...
      get_secret = Mixlib::ShellOut.new("python #{keyvault_get_secret_py} #{vault_name} #{secret_key} #{managed_id}")
